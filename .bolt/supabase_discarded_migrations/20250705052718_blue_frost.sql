...
BEGIN
    ...
    ELSIF admin_exists_auth AND NOT admin_exists_public THEN
        ...
        RAISE NOTICE 'Created public.users entry for admin';
    ...
    ELSIF NOT admin_exists_auth AND admin_exists_public THEN
        ...
        -- Generate consistent UUID for admin
        ...
        RAISE NOTICE 'Created auth.users entry for admin with ID: %', admin_auth_id;
